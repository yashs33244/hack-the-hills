...
import { WalletCards, Menu, X, Bell, Settings, Key } from "lucide-react";
import {
  NavigationMenu,
...
import ViewWalletWithFaceAuth from "./ViewWalletWithFaceAuth";
...
const Header = () => {
  ...
  return (
    <>
                    ...
                    <NavigationMenuContent>
                      <div className="p-4 w-[400px] space-y-2 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded-lg">
                        ...
                        <button
                          ...
                          className="w-full text-left p-2 hover:bg-purple-800 rounded text-white flex items-center"
                        >
                          <Key className="h-4 w-4 mr-2" />
                          View Keys with Face Auth
                        </button>
                      </div>
                    </NavigationMenuContent>
                  </NavigationMenuItem>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              >
                <div className="flex flex-col space-y-4 mt-8">
                  ...
                  <button
                    onClick={() => setShowFaceAuth(true)}
                    className="text-white hover:text-white p-2 flex items-center"
                  >
                    <Key className="h-4 w-4 mr-2" />
                    View Keys with Face Auth
                  </button>
      ...
      <ViewWalletWithFaceAuth
        open={showFaceAuth}
        onOpenChange={setShowFaceAuth}
      />
    </>
  );
};
