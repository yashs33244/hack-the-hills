    ...
    <main className="flex-grow">
      ...
      <div className="container mx-auto px-4 py-20">
        <section className="text-center mb-20">
          <h2
            id="home-heading"
            className="text-5xl md:text-6xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 animate-gradient-x"
          >
            Welcome to Mystic Vault
          </h2>
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            THIS WEBSITE IS FOR DEMONSTRATION PURPOSES ONLY. DO NOT USE
            CRYPTOGRAPHIC KEYS OR PHRASES THAT HAVE REAL SOL OR ETH. MAKE A
            DUMMY WALLET TO TEST OUT THE FUNCTIONALITY.
          </p>
        ...
        <section className="grid md:grid-cols-3 gap-12 mb-20">
          <div className="bg-black bg-opacity-50 backdrop-blur-sm p-10 rounded-2xl text-center transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            <p className="text-gray-300">
              State-of-the-art encryption and security measures to protect your
              digital assets.
            </p>
          </div>
          <div className="bg-black bg-opacity-50 backdrop-blur-sm p-10 rounded-2xl text-center transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            <p className="text-gray-300">
              Maintain full control over your private keys, ensuring true
          ...
          <div className="bg-black bg-opacity-50 backdrop-blur-sm p-10 rounded-2xl text-center transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            <p className="text-gray-300">
              Execute transactions quickly and efficiently across multiple
              blockchains.
            </p>
          </div>
        </section>
        ...
        <section className="text-center bg-black bg-opacity-50 backdrop-blur-sm p-16 rounded-3xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Join thousands of users who trust Mystic Vault for their
            cryptocurrency management needs.
          </p>
          <Button
            onClick={handleScrollToSection}
            className="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white hover:from-purple-500 hover:via-pink-600 hover:to-red-600 text-lg px-10 py-6 rounded-full transition-all duration-300 transform hover:scale-105"
          >
            Create Your Vault
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
